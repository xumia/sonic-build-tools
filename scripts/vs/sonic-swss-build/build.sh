...
docker login -u $REGISTRY_USERNAME -p $REGISTRY_PASSWD sonicrcr1.azurecr.io:443
docker pull sonicrcr1.azurecr.io:443/sonic-slave-stretch:latest
docker run --rm=true --privileged -v $(pwd):/sonic -w /sonic -i sonicrcr1.azurecr.io:443/sonic-slave-stretch:latest ./scripts/vs/sonic-swss-build/build_in_docker.sh
